#///////////////////////////////////////////////////////////////////////////////
#----           Figure 16: Avg Form D Deal Size by Year                    ----
# File name:  1_2_16_yearly_avg_filing_fig16.R
# Author:     Codex (based on Inder Majumdar's workflow)
# Created:    2026-01-26
# Purpose:    Plot average Form D deal size by year, metro vs rural.
#///////////////////////////////////////////////////////////////////////////////
...
formd_yearly_avg_filing <- readRDS(file.path("2_processed_data", "formd_yearly_avg_filing.rds"))

# -----------------------------
# 2) Plot
# -----------------------------

formd_yearly_avg_filing |>
...
save_fig(
  p        = x,
  filename = file.path(output_dir, "16_formD_yearly_avg_filing.jpeg"),
  w        = 16.5,
  h        = 5.5
)
