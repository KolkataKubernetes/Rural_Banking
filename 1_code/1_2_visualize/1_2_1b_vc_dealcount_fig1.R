#///////////////////////////////////////////////////////////////////////////////
#----           Figure 1b: VC Deal Count (BFS-normalized)                 ----
# File name:  1_2_1b_vc_dealcount_fig1.R
# Author:     Codex (based on Inder Majumdar's workflow)
# Created:    2026-02-03
# Purpose:    Plot venture capital deal count comparisons per BFS applications.
#///////////////////////////////////////////////////////////////////////////////
...
avg_data |>
  ...
  theme_im() -> vc_dealcount_bfs

save_fig(
  p = vc_dealcount_bfs,
  filename = file.path(output_dir, "1b_1_vc_dealcount.jpeg"),
  w = 16.5,
  h = 5.5
)
